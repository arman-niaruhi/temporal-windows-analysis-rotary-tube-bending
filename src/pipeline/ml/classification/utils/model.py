...
class LSTMClassifier(nn.Module):
    ...
    def train_model(
        ...
        """
        Training loop with MLflow logging for metrics, confusion matrix, tqdm bars, and early stopping.
        """
        ...
        with mlflow.start_run(run_name=run_name):
            ...
            for epoch in epoch_bar:
                ...
                # --- Confusion Matrix (logged every few epochs) ---
    ...
    def visualize_model(
        self, input_size=10, seq_len=5, batch_size=2, out_file="lstm_model_graph"
    ):
        """
