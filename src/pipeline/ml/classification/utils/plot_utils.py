...
def plot_predictions_vs_true_annot(model, dataset, sensor_df, feature_cols, plot_config, machine_part, objective_label, device="cpu"):
    ...
    model.eval()
    test_exps = [
                2, 3, 22, 23, 40, 54, 83, 85, 110, 112, 119, 120, 121,
                122, 123, 178, 179, 182, 183, 211, 212, 213, 255, 258,
                261, 271, 272, 273, 302, 303, 304, 317, 318
            ]
    ...
    for exp_id in test_exps:
        ...
        plt.tight_layout()
        file_name = store_path / f"labeled_timestamps_{exp_id}.png"
        plt.savefig(
            file_name,
            dpi=300,
            bbox_inches="tight",
